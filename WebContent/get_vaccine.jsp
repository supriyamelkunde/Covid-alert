						...
						<div class="card-body p-5 bg-white rounded">
							<div class="table-responsive">
								<table id="example" style="width: 100%"
									class="table table-striped table-bordered" id="customers">
									<thead>
...
String sql ="select * from vaccine where c_no="+c_no+" ";
...
%>
									...
									<tbody>
										<tr>
											...
											<td><%=resultSet.getInt("center_pincode") %></td>
											<td><%=resultSet.getString("center_address") %></td>
											<td><%=resultSet.getString("v_date") %></td>
											<td><%=resultSet.getString("v_time") %></td>
										</tr>
