...
%>
<center><br>
<h1 class="text-center" style="color:#ffffff;"><strong><u>View Data</strong></h1>
...
String sql ="select * from essential where c_no="+c_no+" ";
...
%>
		  ...
		  <th>Center Pincode </th>
                  <th>Center Address To collect Product </th>
                </tr>
              </thead>
              <tbody>
                <tr>
